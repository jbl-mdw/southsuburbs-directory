// /opt/southsuburbs/frontend/components/CityCard.tsx
...
const CityCard = ({ href, img, title, className = "" }: CityCardProps) => (
  <div
    className={`rounded-lg shadow-lg overflow-hidden h-72 col-span-1 transform transition duration-500 hover:scale-105 ${className}`}
  >
